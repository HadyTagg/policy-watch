...
def _open_ado_connection(db_path: str) -> Any:
    ...
    raise AccessDriverError(
        "Access OLEDB provider not available. Ensure the Access Runtime bitness matches Python "
        "and that the Microsoft Access Database Engine (ACE) provider is installed."
    ) from last_error
