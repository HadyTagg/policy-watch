...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self, username: str, conn: sqlite3.Connection, parent=None):
        ...
        QtCore.QTimer.singleShot(0, self._warm_staff_cache)

    def _warm_staff_cache(self) -> None:
        ...
        try:
            access.ensure_sqlite_cache(access_path, staff_query, table=fallback_table)
        except access.AccessDriverError:
            return
