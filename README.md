...
Policy Watch is a Windows desktop application for organizing, versioning, and distributing policy documents. The application is built with Python 3.11 and PySide6 and stores metadata in SQLite.
